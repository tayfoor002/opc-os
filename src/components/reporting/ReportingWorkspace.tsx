    ...
    try {
      ...
      if (summary) {
        await downloadMonthlyExecutivePptx(
          exportData,
          `synthese-executive-pdd-4-slides-plus-garde-${period.start}-${period.end}.pptx`,
        );
      } else {
      ...
      <div className="no-print flex flex-col justify-between gap-4 xl:flex-row xl:items-end">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            title={type === "monthly" ? "Générer une page de garde et quatre slides de synthèse" : "Disponible avec le rapport mensuel"}
